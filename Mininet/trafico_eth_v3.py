...
Generador de tráfico Ethernet (Scapy) mezclando PCAPs legítimo/maligno. (v3)

Cambios v3 (para tu suite):
...
Ejemplo:
  sudo /home/milenka/Desktop/entorno_tfg/bin/python trafico_eth_v3.py \
...
def main() -> int:
    ...
    # Stats extra para debug/TFG
    print(f"[STATS] pps_target={rate:.1f} pps_real={pps:.2f} sent={total} duration={dt:.2f}s")

    if total == 0:
        print("[ERROR] gen_sent_0: no se enviaron paquetes", file=sys.stderr)
        return 2
